public class Base62 {
	...
	public static final String CONVERTED = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789";

	public static final int BASE = CONVERTED.length();
	...
	private static int fromBase10(int i, final StringBuilder sb) {
		int rem = i % BASE;
		sb.append(CONVERTED.charAt(rem));
		return i / BASE;
	}
	...
	private static int toBase10(char[] chars) {
		...
		for (int i = chars.length - 1; i >= 0; i--) {
			n += toBase10(CONVERTED.indexOf(chars[i]), i);
		}
		return n;
	}
